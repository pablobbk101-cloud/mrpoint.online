/**
 * MR POINT STUDY BUDDY — entry point.
 *   mrpoint.online        → Study Buddy (Quiz / Explain / Mark / Break It Down)
 *   mrpoint.online/chat   → Study Rooms (live AI tutor chat per subject)
 *
 * Files: worker.js (this), ai.js, prompts.js, studypage.js, chatpage.js
 * Requires the Workers AI binding named AI.
 */
